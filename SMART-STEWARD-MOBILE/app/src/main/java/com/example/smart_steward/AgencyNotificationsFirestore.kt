...
object AgencyNotificationsFirestore {
    ...
    /**
     * Standard inbox row when a citizen submits a report assigned to [assignedAgency].
     */
    fun notifyNewReportForAgency(
        ...
        val target = AgencyCanonical.targetKey(assignedAgency)
    ...
    fun sendCitizenNotify(
        ...
        val target = AgencyCanonical.targetKey(report.assignedAgency)
        ...
        FirebaseFirestore.getInstance()
            ...
            .addOnFailureListener { e -> onError(e.message ?: "Could not send notification") }
    }
}
